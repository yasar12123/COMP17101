...
class Dataset(object):
    ...
    # def ExpandingWindowSplit(self, split_ratio, initial_window):
    #     #train split
    ...
    #
    #     # split train data into expanding window
    #     trainX = []
    #     trainY = []
    #     for i in range(initial_window, len(train_X_scaled)):
    #         trainX.append(train_X_scaled[:i])
    #         trainY.append(train_Y_scaled[i + initial_window - 1: i+initial_window])
    #
    ...
    #     testX = []
    #     testY = []
    #     for i in range(initial_window, len(test_X_scaled)):
    #         testX.append(test_X_scaled[:i])
    #         testY.append(test_Y_scaled[i + initial_window - 1: i+initial_window])
    #
